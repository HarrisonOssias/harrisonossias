        ...
        <>
            ...
            <div className="flex h-full w-full flex-col items-center justify-center gap-4 overflow-hidden font-sans">
                ...
                <button
                    ...
                    className="bg-success hover:bg-success/80 text-primary flex items-center gap-2 rounded-lg px-6 py-3 font-mono text-base font-bold shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl active:scale-95 sm:gap-3 sm:px-8 sm:py-4 sm:text-lg"
                >
